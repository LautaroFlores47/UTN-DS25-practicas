...
const sections = [
    {
        name: "Infantil",
        img: "/cat-infantil.jpg",
        desc: "Cuentos y libros para niños"
    },
    {
        name: "Terror",
        img: "/cat-terror.jpg",
        desc: "Historias que dan miedo"
    },
    {
        name: "Ciencia Ficción",
        img: "/cat-scifi.jpg",
        desc: "Futuros posibles"
    },
    {
        name: "Fantasia",
        img: "/cat-fantasia.jpg",
        desc: "Obras imprescindibles"
    }
    ];
    ...
    return (
        <div>
        <h2 style={{ marginBottom: 16 }}>Secciones</h2>
        <div
            style={{
            display: "grid",
            gap: 20,
